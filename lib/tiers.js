...
const TIERS = {
  ...
  red: {
    ...
    description: 'Survival — free Zen models distributed across providers. Zero cost, unlimited use.',
    costRange: '$0/day (Zen free, unlimited)',
    requiresGo: false,
    agents: {
      oracle:     'opencode/qwen3.6-plus-free',
      councillor: 'opencode/qwen3.6-plus-free',
      explorer:   'opencode/deepseek-v4-flash-free',
      librarian:  'opencode/deepseek-v4-flash-free',
      fixer:      'opencode/minimax-m2.5-free',
      designer:   'opencode/qwen3.6-plus-free',
